...
function run(argv = process.argv.slice(2)) {
  ...
  return { project: project.id, profile: profileId, animation: animationId, frames: frames.length, fps: baseFps, sheet: stableSheet };
}
...
module.exports = { cropFromEntry, frameEntries, run };
